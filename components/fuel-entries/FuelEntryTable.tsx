                  ...
                  {entry.warehouse.code === 'DEF-001' ? (
                    <div className="flex items-center" title="Benzinska pumpa">
                      <svg className="w-10 h-10" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <polygon points="452.267,397.799 486.4,397.799 486.4,252.732 452.267,252.732" fill="#dc2626"/>
                        <polygon points="8.533,158.865 503.467,158.865 503.467,107.665 8.533,107.665" fill="#ef4444"/>
                        <polygon points="59.733,397.799 128,397.799 128,158.865 59.733,158.865" fill="#1e293b"/>
                        <polygon points="384,397.799 452.267,397.799 452.267,158.865 384,158.865" fill="#1e293b"/>
                        <path d="M213.333 397.801H162.133V324.261C162.133 317.75 167.415 312.468 173.926 312.468H201.54C208.051 312.468 213.333 317.75 213.333 324.261V397.801Z" fill="#ef4444"/>
                        <path d="M349.867 397.801H298.667V324.261C298.667 317.75 303.949 312.468 310.46 312.468H338.074C344.585 312.468 349.867 317.75 349.867 324.261V397.801Z" fill="#ef4444"/>
                        <polygon points="230.4,252.732 384,252.732 384,218.599 230.4,218.599" fill="#1e293b"/>
                        <polygon points="452.267,252.732 503.467,252.732 503.467,218.599 452.267,218.599" fill="#1e293b"/>
                        <path d="M503.467 406.335H8.533C3.814 406.335 0 402.521 0 397.802C0 393.083 3.814 389.269 8.533 389.269H503.467C508.186 389.269 512 393.083 512 397.802C512 402.521 508.186 406.335 503.467 406.335Z" fill="#ef4444"/>
                      </svg>
                    </div>
                  ) : (
